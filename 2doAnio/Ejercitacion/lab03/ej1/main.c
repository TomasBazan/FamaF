...
int main(int argc, char *argv[])
{
    ...
    /*Calculo la temperatura minimina historica*/
    int minHistorico;
    minHistorico = minTempHis(array);
    printf("\nLa menor temperatura registrada es: %d\n", minHistorico);

    /*Calculo la mayor tempMax para cada anio*/
    int tempMaxAnio [YEARS];
    maxTempAnio(array, tempMaxAnio);
    printf("\n--------------------------\n");
    /*Calculo el mes de cada año que tuvo mayor cantidad de precipitaciones */
    int mesMayorPrec[YEARS];
    maxCantPrec(array, mesMayorPrec);
    return (EXIT_SUCCESS);
}
