...
000000008000008e <start>:
{
  ...
  x &= ~MSTATUS_MPP_MASK;
    ...
    8000009c:	7ff70713          	addi	a4,a4,2047 # ffffffffffffe7ff <end+0xffffffff7ffdca17>
...
kfree(void *pa)
{
  ...
  if(((uint64)pa % PGSIZE) != 0 || (char*)pa < end || (uint64)pa >= PHYSTOP)
    ...
    80000a16:	3d678793          	addi	a5,a5,982 # 80021de8 <end>
...
0000000080000abe <kinit>:
{
  ...
  freerange(end, (void*)PHYSTOP);
    ...
    80000ae6:	30650513          	addi	a0,a0,774 # 80021de8 <end>
...
trapinithart(void)
{
  ...
  asm volatile("csrw stvec, %0" : : "r" (x));
    ...
    80002668:	71c78793          	addi	a5,a5,1820 # 80005d80 <kernelvec>
...
devintr()
{
  ...
  if((scause & 0x8000000000000000L) &&
    ...
    80002788:	704080e7          	jalr	1796(ra) # 80005e88 <plic_claim>
    ...
    800027b6:	6fa080e7          	jalr	1786(ra) # 80005eac <plic_complete>
    return 1;
    ...
    800027cc:	c0e080e7          	jalr	-1010(ra) # 800063d6 <virtio_disk_intr>
...
00000000800027f4 <usertrap>:
{
  ...
  asm volatile("csrw stvec, %0" : : "r" (x));
    ...
    8000280e:	57678793          	addi	a5,a5,1398 # 80005d80 <kernelvec>
...
bread(uint dev, uint blockno)
{
  ...
  return b;
    ...
    80002f10:	23c080e7          	jalr	572(ra) # 80006148 <virtio_disk_rw>
    b->valid = 1;
...
bwrite(struct buf *b)
{
  ...
  virtio_disk_rw(b, 1);
    ...
    80002f3a:	212080e7          	jalr	530(ra) # 80006148 <virtio_disk_rw>
}
...
filealloc(void)
{
  ...
  for(f = ftable.file; f < ftable.file + NFILE; f++){
    ...
    8000443a:	80a70713          	addi	a4,a4,-2038 # 80021c40 <array_semaphores>
    if(f->ref == 0){
...
fdalloc(struct file *f)
{
  ...
  for (fd = 0; fd < NOFILE; fd++)
    80004f6e:	0d050793          	addi	a5,a0,208 # fffffffffffff0d0 <end+0xffffffff7ffdd2e8>
...
void array_init()
{
    ...
    80005b0a:	e422                	sd	s0,8(sp)
    80005b0c:	0800                	addi	s0,sp,16
    for (unsigned int i = 0; i < N; i++)
    80005b0e:	0001c797          	auipc	a5,0x1c
    80005b12:	13278793          	addi	a5,a5,306 # 80021c40 <array_semaphores>
    80005b16:	0001c697          	auipc	a3,0x1c
    80005b1a:	17a68693          	addi	a3,a3,378 # 80021c90 <lock>
    {
        array_semaphores[i] = -1;
    80005b1e:	577d                	li	a4,-1
    80005b20:	c398                	sw	a4,0(a5)
    for (unsigned int i = 0; i < N; i++)
    80005b22:	0791                	addi	a5,a5,4
    80005b24:	fed79ee3          	bne	a5,a3,80005b20 <array_init+0x18>
    }
}
    80005b28:	6422                	ld	s0,8(sp)
    80005b2a:	0141                	addi	sp,sp,16
    80005b2c:	8082                	ret

0000000080005b2e <sys_sem_open>:
...
int sys_sem_open(int sem, int value)
{
    ...
    80005b3a:	feb42423          	sw	a1,-24(s0)
    argint(0, &sem);
    80005b3e:	fec40593          	addi	a1,s0,-20
    80005b42:	4501                	li	a0,0
    80005b44:	ffffd097          	auipc	ra,0xffffd
    80005b48:	f92080e7          	jalr	-110(ra) # 80002ad6 <argint>
    argint(1, &value);
    80005b4c:	fe840593          	addi	a1,s0,-24
    80005b50:	4505                	li	a0,1
    80005b52:	ffffd097          	auipc	ra,0xffffd
    80005b56:	f84080e7          	jalr	-124(ra) # 80002ad6 <argint>
    if (array_semaphores[sem] == -1 && 0 <= sem && sem < N && value >= 0)
    80005b5a:	fec42703          	lw	a4,-20(s0)
    80005b5e:	00271693          	slli	a3,a4,0x2
    80005b62:	0001c797          	auipc	a5,0x1c
    80005b66:	0de78793          	addi	a5,a5,222 # 80021c40 <array_semaphores>
    80005b6a:	97b6                	add	a5,a5,a3
    80005b6c:	4394                	lw	a3,0(a5)
    ...
    if (array_semaphores[sem] == -1 && 0 <= sem && sem < N && value >= 0)
    80005b72:	02f69663          	bne	a3,a5,80005b9e <sys_sem_open+0x70>
    80005b76:	0007079b          	sext.w	a5,a4
    80005b7a:	46cd                	li	a3,19
        return 0;
    80005b7c:	4501                	li	a0,0
    if (array_semaphores[sem] == -1 && 0 <= sem && sem < N && value >= 0)
    80005b7e:	02f6e063          	bltu	a3,a5,80005b9e <sys_sem_open+0x70>
    80005b82:	fe842783          	lw	a5,-24(s0)
    80005b86:	0007cc63          	bltz	a5,80005b9e <sys_sem_open+0x70>
        array_semaphores[sem] = value;
    80005b8a:	070a                	slli	a4,a4,0x2
    80005b8c:	0001c697          	auipc	a3,0x1c
    80005b90:	0b468693          	addi	a3,a3,180 # 80021c40 <array_semaphores>
    80005b94:	9736                	add	a4,a4,a3
    80005b96:	c31c                	sw	a5,0(a4)
        if (value == 0)
    80005b98:	c799                	beqz	a5,80005ba6 <sys_sem_open+0x78>
        return sem;
    80005b9a:	fec42503          	lw	a0,-20(s0)
    }
}
    ...
    80005ba6:	0001c597          	auipc	a1,0x1c
    80005baa:	0ea58593          	addi	a1,a1,234 # 80021c90 <lock>
    80005bae:	8536                	mv	a0,a3
    80005bb0:	ffffc097          	auipc	ra,0xffffc
    80005bb4:	4ba080e7          	jalr	1210(ra) # 8000206a <sleep>
    80005bb8:	b7cd                	j	80005b9a <sys_sem_open+0x6c>

0000000080005bba <sys_sem_close>:
...
int sys_sem_close(int sem)
{
    ...
    argint(0, &sem);
    80005bc6:	fec40593          	addi	a1,s0,-20
    80005bca:	4501                	li	a0,0
    80005bcc:	ffffd097          	auipc	ra,0xffffd
    80005bd0:	f0a080e7          	jalr	-246(ra) # 80002ad6 <argint>

    if (array_semaphores[sem] < 0)
    80005bd4:	fec42783          	lw	a5,-20(s0)
    80005bd8:	00279713          	slli	a4,a5,0x2
    80005bdc:	0001c797          	auipc	a5,0x1c
    80005be0:	06478793          	addi	a5,a5,100 # 80021c40 <array_semaphores>
    80005be4:	97ba                	add	a5,a5,a4
    80005be6:	439c                	lw	a5,0(a5)
    80005be8:	0407cb63          	bltz	a5,80005c3e <sys_sem_close+0x84>
    {
        return -1;
    }
    acquire(&lock);
    80005bec:	0001c517          	auipc	a0,0x1c
    80005bf0:	0a450513          	addi	a0,a0,164 # 80021c90 <lock>
    80005bf4:	ffffb097          	auipc	ra,0xffffb
    80005bf8:	ff6080e7          	jalr	-10(ra) # 80000bea <acquire>
    if (array_semaphores[sem] >= 0)
    80005bfc:	fec42703          	lw	a4,-20(s0)
    80005c00:	00271693          	slli	a3,a4,0x2
    80005c04:	0001c797          	auipc	a5,0x1c
    80005c08:	03c78793          	addi	a5,a5,60 # 80021c40 <array_semaphores>
    80005c0c:	97b6                	add	a5,a5,a3
    80005c0e:	439c                	lw	a5,0(a5)
    80005c10:	0007ca63          	bltz	a5,80005c24 <sys_sem_close+0x6a>
    {
        array_semaphores[sem] = 0;
    80005c14:	0001c797          	auipc	a5,0x1c
    80005c18:	02c78793          	addi	a5,a5,44 # 80021c40 <array_semaphores>
    80005c1c:	00d78733          	add	a4,a5,a3
    80005c20:	00072023          	sw	zero,0(a4)
    }
    release(&lock);
    80005c24:	0001c517          	auipc	a0,0x1c
    80005c28:	06c50513          	addi	a0,a0,108 # 80021c90 <lock>
    80005c2c:	ffffb097          	auipc	ra,0xffffb
    80005c30:	072080e7          	jalr	114(ra) # 80000c9e <release>
    return 0;
    ...
    80005c40:	bfdd                	j	80005c36 <sys_sem_close+0x7c>

0000000080005c42 <sys_sem_up>:
...
int sys_sem_up(int sem)
{
    ...
    80005c4e:	fca42e23          	sw	a0,-36(s0)
    argint(0, &sem);
    80005c52:	fdc40593          	addi	a1,s0,-36
    80005c56:	4501                	li	a0,0
    80005c58:	ffffd097          	auipc	ra,0xffffd
    80005c5c:	e7e080e7          	jalr	-386(ra) # 80002ad6 <argint>
    if (array_semaphores[sem] > -1)
    80005c60:	fdc42783          	lw	a5,-36(s0)
    80005c64:	00279713          	slli	a4,a5,0x2
    80005c68:	0001c797          	auipc	a5,0x1c
    80005c6c:	fd878793          	addi	a5,a5,-40 # 80021c40 <array_semaphores>
    80005c70:	97ba                	add	a5,a5,a4
    80005c72:	439c                	lw	a5,0(a5)
        release(&lock);
        return sem;
    }
    else
    ...
    if (array_semaphores[sem] > -1)
    80005c76:	0007d863          	bgez	a5,80005c86 <sys_sem_up+0x44>
    }
}
    ...
    80005c82:	6145                	addi	sp,sp,48
    80005c84:	8082                	ret
        acquire(&lock);
    80005c86:	0001c917          	auipc	s2,0x1c
    80005c8a:	fba90913          	addi	s2,s2,-70 # 80021c40 <array_semaphores>
    80005c8e:	0001c497          	auipc	s1,0x1c
    80005c92:	00248493          	addi	s1,s1,2 # 80021c90 <lock>
    80005c96:	8526                	mv	a0,s1
    80005c98:	ffffb097          	auipc	ra,0xffffb
    80005c9c:	f52080e7          	jalr	-174(ra) # 80000bea <acquire>
        array_semaphores[sem] = array_semaphores[sem] + 1;
    80005ca0:	fdc42783          	lw	a5,-36(s0)
    80005ca4:	078a                	slli	a5,a5,0x2
    80005ca6:	97ca                	add	a5,a5,s2
    80005ca8:	4398                	lw	a4,0(a5)
    80005caa:	2705                	addiw	a4,a4,1
    80005cac:	c398                	sw	a4,0(a5)
        wakeup(array_semaphores);
    80005cae:	854a                	mv	a0,s2
    80005cb0:	ffffc097          	auipc	ra,0xffffc
    80005cb4:	41e080e7          	jalr	1054(ra) # 800020ce <wakeup>
        release(&lock);
    80005cb8:	8526                	mv	a0,s1
    80005cba:	ffffb097          	auipc	ra,0xffffb
    80005cbe:	fe4080e7          	jalr	-28(ra) # 80000c9e <release>
        return sem;
    80005cc2:	fdc42503          	lw	a0,-36(s0)
    80005cc6:	bf55                	j	80005c7a <sys_sem_up+0x38>

0000000080005cc8 <sys_sem_down>:
...
int sys_sem_down(int sem)
{
    ...
    argint(0, &sem);
    80005cd8:	fdc40593          	addi	a1,s0,-36
    80005cdc:	4501                	li	a0,0
    80005cde:	ffffd097          	auipc	ra,0xffffd
    80005ce2:	df8080e7          	jalr	-520(ra) # 80002ad6 <argint>
    acquire(&lock);
    80005ce6:	0001c517          	auipc	a0,0x1c
    80005cea:	faa50513          	addi	a0,a0,-86 # 80021c90 <lock>
    80005cee:	ffffb097          	auipc	ra,0xffffb
    80005cf2:	efc080e7          	jalr	-260(ra) # 80000bea <acquire>
    while (array_semaphores[sem] == 0)
    80005cf6:	fdc42783          	lw	a5,-36(s0)
    80005cfa:	00279713          	slli	a4,a5,0x2
    80005cfe:	0001c797          	auipc	a5,0x1c
    80005d02:	f4278793          	addi	a5,a5,-190 # 80021c40 <array_semaphores>
    80005d06:	97ba                	add	a5,a5,a4
    80005d08:	439c                	lw	a5,0(a5)
    80005d0a:	e78d                	bnez	a5,80005d34 <sys_sem_down+0x6c>
    {
        sleep(array_semaphores, &lock);
    80005d0c:	0001c497          	auipc	s1,0x1c
    80005d10:	f3448493          	addi	s1,s1,-204 # 80021c40 <array_semaphores>
    80005d14:	0001c917          	auipc	s2,0x1c
    80005d18:	f7c90913          	addi	s2,s2,-132 # 80021c90 <lock>
    80005d1c:	85ca                	mv	a1,s2
    80005d1e:	8526                	mv	a0,s1
    80005d20:	ffffc097          	auipc	ra,0xffffc
    80005d24:	34a080e7          	jalr	842(ra) # 8000206a <sleep>
    while (array_semaphores[sem] == 0)
    80005d28:	fdc42783          	lw	a5,-36(s0)
    80005d2c:	078a                	slli	a5,a5,0x2
    80005d2e:	97a6                	add	a5,a5,s1
    80005d30:	439c                	lw	a5,0(a5)
    80005d32:	d7ed                	beqz	a5,80005d1c <sys_sem_down+0x54>
    }
    release(&lock);
    80005d34:	0001c517          	auipc	a0,0x1c
    80005d38:	f5c50513          	addi	a0,a0,-164 # 80021c90 <lock>
    80005d3c:	ffffb097          	auipc	ra,0xffffb
    80005d40:	f62080e7          	jalr	-158(ra) # 80000c9e <release>

    if (array_semaphores[sem] != -1 && array_semaphores[sem] > 0)
    80005d44:	fdc42703          	lw	a4,-36(s0)
    80005d48:	00271693          	slli	a3,a4,0x2
    80005d4c:	0001c797          	auipc	a5,0x1c
    80005d50:	ef478793          	addi	a5,a5,-268 # 80021c40 <array_semaphores>
    80005d54:	97b6                	add	a5,a5,a3
    80005d56:	439c                	lw	a5,0(a5)
    80005d58:	00f05a63          	blez	a5,80005d6c <sys_sem_down+0xa4>
    {
        array_semaphores[sem] = array_semaphores[sem] - 1;
    80005d5c:	8736                	mv	a4,a3
    80005d5e:	0001c697          	auipc	a3,0x1c
    80005d62:	ee268693          	addi	a3,a3,-286 # 80021c40 <array_semaphores>
    80005d66:	9736                	add	a4,a4,a3
    80005d68:	37fd                	addiw	a5,a5,-1
    80005d6a:	c31c                	sw	a5,0(a4)
    }
...
0000000080005d80 <kernelvec>:
    ...
    80005dc0:	b45fc0ef          	jal	ra,80002904 <kerneltrap>
...
free_desc(int i)
{
  ...
  if(disk.free[i])
    ...
    80005ee8:	dc478793          	addi	a5,a5,-572 # 80021ca8 <disk>
  ...
  disk.desc[i].addr = 0;
    ...
    80005efc:	db078793          	addi	a5,a5,-592 # 80021ca8 <disk>
  ...
  wakeup(&disk.free[0]);
    ...
    80005f24:	da050513          	addi	a0,a0,-608 # 80021cc0 <disk+0x18>
    80005f28:	ffffc097          	auipc	ra,0xffffc
    80005f2c:	1a6080e7          	jalr	422(ra) # 800020ce <wakeup>
}
    ...
    80005f4c:	82850513          	addi	a0,a0,-2008 # 80008770 <syscalls+0x320>
...
0000000080005f58 <virtio_disk_init>:
{
  ...
  initlock(&disk.vdisk_lock, "virtio_disk");
    ...
    80005f68:	81c58593          	addi	a1,a1,-2020 # 80008780 <syscalls+0x330>
    80005f6c:	0001c517          	auipc	a0,0x1c
    80005f70:	e6450513          	addi	a0,a0,-412 # 80021dd0 <disk+0x128>
  ...
  *R(VIRTIO_MMIO_STATUS) = status;
  ...
  features &= ~(1 << VIRTIO_RING_F_INDIRECT_DESC);
    ...
    80005fd4:	75f70713          	addi	a4,a4,1887 # ffffffffc7ffe75f <end+0xffffffff47fdc977>
  ...
  *R(VIRTIO_MMIO_QUEUE_SEL) = 0;
  ...
  disk.desc = kalloc();
    ...
    8000601e:	c8e48493          	addi	s1,s1,-882 # 80021ca8 <disk>
  ...
  if(!disk.desc || !disk.avail || !disk.used)
    ...
    8000603e:	0001c717          	auipc	a4,0x1c
    80006042:	c7273703          	ld	a4,-910(a4) # 80021cb0 <disk+0x8>
  ...
  memset(disk.avail, 0, PGSIZE);
    80006056:	0001c497          	auipc	s1,0x1c
    8000605a:	c5248493          	addi	s1,s1,-942 # 80021ca8 <disk>
...
virtio_disk_rw(struct buf *b, int write)
{
  ...
  acquire(&disk.vdisk_lock);
    ...
    8000617a:	c5a50513          	addi	a0,a0,-934 # 80021dd0 <disk+0x128>
  ...
  for(int i = 0; i < NUM; i++){
    80006188:	4ba1                	li	s7,8
      disk.free[i] = 0;
    8000618a:	0001cb17          	auipc	s6,0x1c
    8000618e:	b1eb0b13          	addi	s6,s6,-1250 # 80021ca8 <disk>
  for(int i = 0; i < 3; i++){
  ...
  while(1){
    ...
    80006196:	0001cc17          	auipc	s8,0x1c
    8000619a:	c3ac0c13          	addi	s8,s8,-966 # 80021dd0 <disk+0x128>
  ...
  for(int i = 0; i < NUM; i++){
    800061b8:	0001c697          	auipc	a3,0x1c
    800061bc:	af068693          	addi	a3,a3,-1296 # 80021ca8 <disk>
  ...
  for(int i = 0; i < NUM; i++){
    ...
    8000620e:	ab650513          	addi	a0,a0,-1354 # 80021cc0 <disk+0x18>
    80006212:	ffffc097          	auipc	ra,0xffffc
    80006216:	e58080e7          	jalr	-424(ra) # 8000206a <sleep>
  for(int i = 0; i < 3; i++){
  ...
  if(write)
    ...
    8000622a:	0001c797          	auipc	a5,0x1c
    8000622e:	a7e78793          	addi	a5,a5,-1410 # 80021ca8 <disk>
  ...
  buf0->reserved = 0;
    80006238:	0001c597          	auipc	a1,0x1c
    8000623c:	a7058593          	addi	a1,a1,-1424 # 80021ca8 <disk>
  ...
  disk.info[idx[0]].status = 0xff; // device writes 0 on success
    800062a0:	0001c697          	auipc	a3,0x1c
    800062a4:	a0868693          	addi	a3,a3,-1528 # 80021ca8 <disk>
  ...
  *R(VIRTIO_MMIO_QUEUE_NOTIFY) = 0; // value is queue number
  ...
  while(b->disk == 1) {
    ...
    80006312:	0001c997          	auipc	s3,0x1c
    80006316:	abe98993          	addi	s3,s3,-1346 # 80021dd0 <disk+0x128>
  while(b->disk == 1) {
    ...
    80006324:	d4a080e7          	jalr	-694(ra) # 8000206a <sleep>
  while(b->disk == 1) {
  ...
  disk.info[idx[0]].b = 0;
    ...
    8000633c:	0001c797          	auipc	a5,0x1c
    80006340:	96c78793          	addi	a5,a5,-1684 # 80021ca8 <disk>
    80006344:	97ba                	add	a5,a5,a4
    80006346:	0007b423          	sd	zero,8(a5)
    int flag = disk.desc[i].flags;
    8000634a:	0001c997          	auipc	s3,0x1c
    8000634e:	95e98993          	addi	s3,s3,-1698 # 80021ca8 <disk>
  ...
  release(&disk.vdisk_lock);
    80006372:	0001c517          	auipc	a0,0x1c
    80006376:	a5e50513          	addi	a0,a0,-1442 # 80021dd0 <disk+0x128>
  ...
  struct virtio_blk_req *buf0 = &disk.ops[idx[0]];
    ...
    800063b0:	0001c517          	auipc	a0,0x1c
    800063b4:	90050513          	addi	a0,a0,-1792 # 80021cb0 <disk+0x8>
  ...
  if(write)
    ...
    800063c6:	0001c797          	auipc	a5,0x1c
    800063ca:	8e278793          	addi	a5,a5,-1822 # 80021ca8 <disk>
...
virtio_disk_intr()
{
  ...
  acquire(&disk.vdisk_lock);
    800063e0:	0001c497          	auipc	s1,0x1c
    800063e4:	8c848493          	addi	s1,s1,-1848 # 80021ca8 <disk>
    800063e8:	0001c517          	auipc	a0,0x1c
    800063ec:	9e850513          	addi	a0,a0,-1560 # 80021dd0 <disk+0x128>
  ...
  *R(VIRTIO_MMIO_INTERRUPT_ACK) = *R(VIRTIO_MMIO_INTERRUPT_STATUS) & 0x3;
  ...
  while(disk.used_idx != disk.used->idx){
    ...
    80006444:	c8e080e7          	jalr	-882(ra) # 800020ce <wakeup>
  ...
  release(&disk.vdisk_lock);
    ...
    80006464:	97050513          	addi	a0,a0,-1680 # 80021dd0 <disk+0x128>
    ...
    8000647e:	3ce50513          	addi	a0,a0,974 # 80008848 <syscalls+0x3f8>
