...
* @param s A stack
* @return An array containing all the elements of the stack. 
* The stack top element becomes the rightmost element of the array. 
* The size of the resulting array is determined by 'stack_size(s)'
*/
