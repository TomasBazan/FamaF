...
import Dibujo (Dibujo, figura, juntar, apilar, rot45, rotar90, encimar, espejar)
...
testAll = grilla [
    ...
    [flipante1 Rectangulo, flipante2 Rectangulo, figRoja Triangulo  , rotar90 $ figAzul Triangulo],
    [rotar90 $ apilados Efe, apilados2 Efe       , juntados Efe       , juntados2 Efe            ]
    ]
