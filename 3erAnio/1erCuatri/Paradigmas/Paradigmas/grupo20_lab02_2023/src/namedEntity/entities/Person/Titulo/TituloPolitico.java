...
public class TituloPolitico extends TituloBase implements Politic{
    private String politic_party;
    private String politic_position;
    private String politic_country;
    
    public TituloPolitico(int frequency, String string, String nombre_canonico, String person_id, String forma_canonica, String origen,  String politic_party, String politic_position, String politic_country) {
	...
	public void prettyPrint() {
		System.out.println("TituloPoliticoN [politic_party=" + politic_party + ", politic_position=" + politic_position + ", politic_country=" + politic_country + ", forma canonica=" + getFormaCanonica()  + ", person_id=" + getPersonId() + ", nombre canonico=" + getCanonicName() + ", string=" + getString() + "]");
	}
}
